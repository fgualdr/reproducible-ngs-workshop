...
Day 4 combines RNA-seq and ChIP-seq outputs. You will connect differential expression results to nearby ChIP-seq peaks, produce interpretable figures and prepare a concise three-slide lab-meeting summary.
...
The exact values are assumptions. In this practical, a fixed window such as 500 bp upstream and 100 bp downstream is acceptable if it is clearly documented.
...
Slide 1 - Data and design
  ...
  use the current archive name: ArrayExpress collection in BioStudies; linked raw reads in ENA
...
Slide 2 - Workflow and quality control
  ...
  explicitly state: workshop WT-only/no-external-control ChIP reanalysis ≠ published WT/ΔHP1021 csaw/edgeR + MACS3 analysis
...
If you have a GitHub account, report Day 4 problems by opening an **Issue** in your repository.
