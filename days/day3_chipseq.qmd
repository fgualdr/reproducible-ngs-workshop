...
If the Bowtie2 index is missing, run the Day 2 index-building step before continuing. The same genome index can be used for RNA-seq and ChIP-seq because both workflows map reads to the same *H. pylori* reference genome.
...
| `-g 1.7e6` | Approximate mappable genome size for this small bacterial genome |
...
## 9. Optional QC: replicate peak consistency with IDR
...
## 12. Motif discovery with STREME
